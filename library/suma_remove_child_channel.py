...
description:
    - "This module will remove a child channel to a host and make sure it is scheduled as soon as possible"
...
def remove_child_channel():
    ...
    channel = []
    channel_name = module.params['child_channel']
    ...
    for channels in child_channels_json['result']:
        ...
        if cchannel_labels != channel_name:
